...
const PostModal: React.FC <PostModalProps> = ({ onClose, onSubmit }) => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-900 bg-opaxity-50 flex justify-center items-center">
            <div className="bg-white rounded-lg p-8 shadow-lg w-full mx-w-md">
                ...
                <form action="" onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input type="number" id="userId" name="userId" value={post.userId} className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>

                    <div className="mb-4">
                        <label htmlFor="body" className="block text-gray-700 font-medium mb-2">Body</label>
                        <textarea name="body" id="body" value={post.body} onChange={handleChange} rows={4} 
                        className="w-full px-4 py-2 rounded-lg focus:outline focus:ring-2 focus:ring-blue-500" placeholder="Enter Post Content"></textarea>
                    </div>
